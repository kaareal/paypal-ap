...
PayPal.prototype.pay = function(options, callback) {
  var currencyCode =  this.options.currencyCode || options.currencyCode,
      cancelUrl = this.options.cancelUrl || options.cancelUrl,
      returnUrl = this.options.returnUrl || options.returnUrl,
      errorLanguage = this.options.errorLanguage || options.errorLanguage;
